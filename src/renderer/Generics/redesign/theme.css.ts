...
export const [lightTheme, vars] = createTheme({
  color: {
    ...
    primaryLink: common.color.purple600,
    primaryLinkHover: common.color.purple800,
  ...
  components: {
    ...
    disabledBackground: common.color.black4,
    ...
    labelOrange2Background: common.color.orange200,
    ...
    labelOrange2FontColor: common.color.black85,
...
export const darkTheme = createTheme(vars, {
  color: {
    ...
    primaryLink: common.color.purple500,
  ...
  components: {
    ...
    disabledBackground: common.color.white4,
    ...
    labelOrange2Background: 'rgba(251, 146, 65, 0.25)',
    ...
    labelOrange2FontColor: common.color.white70,

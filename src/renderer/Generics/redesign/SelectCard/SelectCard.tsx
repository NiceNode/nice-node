...
import { Tag } from '../Tag';
import { container, descriptionStyle, selectedContainer, tagStyle, textContainer, titleStyle } from './selectCard.css';
...
const SelectCard = ({
  ...
  return (
    ...
    <div className={containerStyles.join(" ")}>
      ...
      {minority && <div className={tagStyle}><Tag  type="pink" label="Minority Client" />    </div>
}
    </div>
  );
};
